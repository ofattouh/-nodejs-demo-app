// Three Columns widget used in the Footer section

module.exports = {
  extend: 'apostrophe-widgets',
  label: 'Footer Widget (3 cols)',
  // contextualOnly: true,
  addFields: [
    {
      name: 'left3ColsFooter',
      type: 'area',
    ...
    {
      name: 'middle3ColsFooter',
      type: 'area',
      label: 'Middle Footer Area',
      options: {
        widgets: {
          'apostrophe-rich-text': {
             toolbar: [ 'Styles', 'Bold', 'Italic', 'Link', 'Unlink', 'Anchor', 'Table', 'BulletedList', 'Blockquote', 'Strike', 'Subscript', 'Superscript', 'Split'],
